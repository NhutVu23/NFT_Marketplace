    ...
    <div class="main main-raised">
      <div class="section">
        <div class="container">
              ...
              <full-bg-card :card-image="cardProject.cardProject1">
                <template slot="cardContent">
                  ...
                  <a href="javascript:void(0)">
                    <h3 class="card-title">Async Music Auctions</h3>
                  </a>
                  <p class="card-description">
                    Unique works from Pak, Mike Shinoda, Richie Hawtin and
                    more...
                  </p>
                  <md-button
            ...
            <div class="md-layout-item md-size-50 md-small-size-100">
              <full-bg-card :card-image="cardProject.cardProject2">
                <template slot="cardContent">
                  ...
                  <a href="javascript:void(0)">
                    <h3 class="card-title">The Underground Sistine Chapel</h3>
                  </a>
                  <p class="card-description">
          ...
          <h2 class="section-title text-center">Live Auctions</h2>
          <div class="md-layout">
